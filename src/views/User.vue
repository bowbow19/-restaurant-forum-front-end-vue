...
<template>
  <div class="container py-5">
    <h1>個人資料描述頁</h1>
    <!-- 個人資料 UserProfileCard -->
    <UserProfileCard  :initialProfile="profile" />
    <hr>
    <!-- UserFloolwingsCard -->
    <UserFollowingsCard :UserFollowingsCard="Followings"/>
    <!-- UserFollowersCard -->
    <UserFollowersCard :UserFollowersCard="Followers"/>
    <!-- UserCommentsCard -->
    <UserCommentsCard :UserCommentsCard="Comments"/>
    <!-- UserFavoritedRestaurantCard -->
    <UserFavoritedRestaurantsCard :UserFavoritedRestaurantsCard="FavoritedRestaurants" />
  </div> 
</template>
     ...
     methods:{
       fetchUser(UserId){
         ...
         this.profile= {
           ...
           following:dummyData.profile.Followings.length,
